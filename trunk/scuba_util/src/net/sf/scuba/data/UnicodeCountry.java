...
//	AC = new UnicodeCountry(-1, "AC", "XXX", "Ascension Island"),
	...
	AX = new UnicodeCountry(0x248, "AX", "ALA", "�land Islands", ""),
	...
	BL = new UnicodeCountry(0x652, "BL", "BLM", "Saint Barth�lemy", ""),
...
//	BQ = new UnicodeCountry(-1, "BQ", "XXX", "Caribbean Netherlands"),
	...
	CI = new UnicodeCountry(0x384, "CI", "CIV", "C�te d�Ivoire", "Ivorian"),
...
//	QO = new UnicodeCountry(-1, "QO", "XXX", "Outlying Oceania"),
	RE = new UnicodeCountry(0x638, "RE", "REU", "R�union", "Reunionese, Reunionnais"),
...
//	SS = new UnicodeCountry(-1, "SS", "XXX", "South Sudan"),
	ST = new UnicodeCountry(0x678, "ST", "STP", "S�o Tom� and Pr�ncipe", "Sao Tomean"),
